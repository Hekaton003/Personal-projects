...
import Video from "../../../video/The new Rolex Yacht-Master 42.mp4";
import {
    FacebookLogo,
    InstagramLogo,
    LinkedinLogo,
...
function Ymaster42(){
    return(
        <div id='Ymaster42'>
            ...
            <h1>Yacht-Master 42 watches</h1>
            <div id='main'>
                <div id='containerNew'>
                        <div className='NewBlock'>
                            <img src='https://content.rolex.com/v7/dam/2023-06/upright-c/m226627-0001.png?impolicy=v7&imwidth=1920' alt='watch'/>
                            <h3>Yacht Master</h3>
                            <p>Oyster,42mm, RXL titanium</p>
                            <button><a href='https://www.rolex.com/watches/yacht-master/m226627-0001' target='_blank' style={{textDecoration:'none', color:'black',fontSize:'15px',fontStyle:'oblique'}}>More Detail</a></button>
                        </div>
                </div>
                <Menu/>
