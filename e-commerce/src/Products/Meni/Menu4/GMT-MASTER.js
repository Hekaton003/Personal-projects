...
import Video from "../../../video/The new Rolex GMT-Master II.mp4";
import {
    FacebookLogo,
    InstagramLogo,
    LinkedinLogo,
...
function NewGMT(){
    return(
        <div id='gmt-master'>
            ...
            <h1>GMT-Master II latest watches</h1>
            <div id='main'>
                <div id='containerNew'>
                    <div className='NewBlock'>
                        <img src='https://content.rolex.com/v7/dam/2023-06/upright-c/m126713grnr-0001.png?impolicy=v7&imwidth=1920' alt='watch'/>
                        <h3>GMT-Master-II</h3>
                        <p>Oyster,40mm,Oystersteel and yellow gold</p>
                        <button><a href='https://www.rolex.com/watches/gmt-master-ii/m126713grnr-0001' target='_blank' style={{textDecoration:'none', color:'black',fontSize:'15px',fontStyle:'oblique'}}>More Detail</a></button>
                    </div>
                    <div className='NewBlock'>
                        <img src='https://content.rolex.com/v7/dam/2023-06/upright-c/m126718grnr-0001.png?impolicy=v7&imwidth=1920' alt='watch'/>
                        <h3>GMT-Master-II</h3>
                        <p>Oyster,40mm,yellow gold</p>
                        <button><a href='https://www.rolex.com/watches/gmt-master-ii/m126718grnr-0001' target='_blank' style={{textDecoration:'none', color:'black',fontSize:'15px',fontStyle:'oblique'}}>More Detail</a></button>
                    </div>
                </div>
                <Menu/>
