...
import Video from "../../../video/The new Rolex Explorer.mp4";
import {
    FacebookLogo,
    InstagramLogo,
    LinkedinLogo,
...
function NewExplorer(){
    return(
        <div id='explorer'>
            ...
            <h1>Explorer 40 latest watches</h1>
            <div id='main'>
                <div id='containerNew'>
                    <div className='NewBlock'>
                        <img src='https://content.rolex.com/v7/dam/2023-06/upright-c/m224270-0001.png?impolicy=v7&imwidth=1920' alt='watch'/>
                        <h3>Explorer 40</h3>
                        <p> Oyster, 40mm, Oystersteel</p>
                        <button><a href='https://www.rolex.com/watches/explorer/m224270-0001' target='_blank' style={{textDecoration:'none', color:'black',fontSize:'15px',fontStyle:'oblique'}}>More Detail</a></button>
                    </div>
                </div>
                <Menu/>
